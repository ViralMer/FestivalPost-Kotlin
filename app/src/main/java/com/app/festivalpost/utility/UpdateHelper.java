...
public class UpdateHelper {
    ...
    public UpdateHelper(Context context, com.app.Utils.UpdateHelper.onUpdateCheckListener onUpdateCheckListener) {
    ...
    public static class Builder{
        ...
        public com.app.Utils.UpdateHelper build()
        {
            return new com.app.Utils.UpdateHelper(context,onUpdateCheckListener);
        }

        public com.app.Utils.UpdateHelper check()
        {
            com.app.Utils.UpdateHelper updateHelper=build();
            updateHelper.check();
