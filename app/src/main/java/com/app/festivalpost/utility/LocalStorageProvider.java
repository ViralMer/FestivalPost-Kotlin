...
/**
 * Created by Waycreon on 8/20/2015.
 */
...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        //row.add(Root.COLUMN_ICON, R.drawable.song);
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            Log.e(com.app.Utils.LocalStorageProvider.class.getSimpleName(), "Error creating new file " + newFile);
        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            ...
            Log.e(com.app.Utils.LocalStorageProvider.class.getSimpleName(), "Error writing thumbnail", e);
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Log.e(com.app.Utils.LocalStorageProvider.class.getSimpleName(), "Error closing thumbnail", e);
                }
        }
