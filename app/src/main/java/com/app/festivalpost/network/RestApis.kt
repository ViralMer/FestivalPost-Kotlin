...
import com.emegamart.lelys.utils.extensions.getUserId
...
interface RestApis {
    ...
    fun filterProduct(@Header("Content-Type") contentType: String = "application/json", @Body request: FilterProductRequest?): Call<ArrayList<ProductDataNew>>
     ...
     @POST("woobox-api/api/v1/woocommerce/get-product")
    fun filterProductNew(@Header("Content-Type") contentType: String = "application/json", @Body request: FilterProductRequestNew?): Call<ArrayList<ProductDataNew>>
    ...
    @POST("woobox-api/api/v1/woocommerce/get-product")
    fun getProductCategoriesUsingID(@Body request: RequestModel): Call<ArrayList<ProductDataNew>>
    ...
    @GET("woobox-api/api/v1/rewards/rewards-data")
    fun getRewardsPoints():Call<ArrayList<RewardsOptionItem>>


    @GET("wc/v3/coupons")
    fun getCouponList():Call<ArrayList<CouponItemDetails>>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/forgot-password")
    fun forgetPasswordNew(@Field("email") email: String):Call<ForgetPassword>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/user-productlist")
    fun userProductList(@Field("customer") customer: String):Call<UserProductList>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/forgot-change-password")
    fun forgetChangePassword(@Field("token") token: String, @Field("password") password: String):Call<ForgetPassword>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/get-rewardpoints")
    fun getRewardsPointsData(@Field("customer") userID: String, @Field("cart_total") cart_total: String, @Field("user_point") user_point: String):Call<RewardsPointsItemDetails>


    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/testing")
    fun getCustomerTesting(@Field("unm")username:String,@Field("pwd") pwd:String):Call<LoginResponseNew>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/affiliate-commissions")
    fun getAffiliateComissions(@Field("uid")uid:String,@Field("from_date")from_date:String,@Field("to_date")to_date:String,@Field("page")page:Int):Call<AffiliateCommissionsResponse>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/affiliate-clicks")
    fun getAffiliateClicks(@Field("uid")uid:String,@Field("from_date")from_date:String,@Field("to_date")to_date:String,@Field("page")page:Int):Call<AffiliateClickResponse>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/affiliate-payments")
    fun getAffiliatePayments(@Field("uid")uid:String,@Field("from_date")from_date:String,@Field("to_date")to_date:String,@Field("page")page:Int):Call<AffiliatePaymentResponse>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/affiliate-settings")
    fun getAffiliateSettings(@Field("uid")uid:String):Call<AffiliateSettingsResponse>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/affiliate-dahsboard")
    fun getAffiliateDashboard(@Field("uid")uid:String):Call<AffiliateDashboardResponse>


    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/affiliate-link")
    fun getGenerateLink(@Field("uid")uid:String,@Field("url")url:String):Call<AffiliateLinkResponse>


    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/payment-email-update")
    fun getAffiliateEmailUpdate(@Field("uid")uid:String,@Field("email")email:String):Call<AffiliateEmailUpdate>


    @FormUrlEncoded
    @POST("woobox-api/api/v1/rewards/rewards-history")
    fun rewardHistory(@Field("id")uid:String):Call<RewardHistoryResponse>


    @GET("woobox-api/api/v1/cart/shipping-charge")
    fun shippingCharge():Call<ShippingChargeResponse>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/contactus/contact-us")
    fun contactus(@Field("name")name:String,@Field("email")email:String,@Field("phoneno")number:String,@Field("message")message:String):Call<ContactUs>


    @FormUrlEncoded
    @POST("woobox-api/api/v1/contactus/newsletter")
    fun newssellter(@Field("fnm")fname:String,@Field("lnm")lname:String,@Field("email")email:String):Call<NewsSeltterResponse>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/facebook-share")
    fun facebookShareId(@Field("uid")uid:String):Call<FacebookShareLinkResponse>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/product-review")
    fun reviewRedeem(@Field("uid")uid:String,@Field("pid")pid:String):Call<FacebookShareLinkResponse>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/remove-points")
    fun redeempointapply(@Field("user_id")uid:String,@Field("orderid")orderid:String,@Field("points")points:String,@Field("coupon")coupon:String):Call<FacebookShareLinkResponse>

    @FormUrlEncoded
    @POST("woobox-api/api/v1/customer/remove-coupon")
    fun couponcodeDelete(@Field("coupon")coupon:String):Call<FacebookShareLinkResponse>
