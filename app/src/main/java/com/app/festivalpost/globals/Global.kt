...
object Global {
    ...
    val allFramesNew: ArrayList<LocalFrameItemNew>
        get() {
            ...
            val mInflater1 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater3 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater4 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater5 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater6 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater7 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater8 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater9 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater11 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater12 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater13 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater14 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater15 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater16 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater17 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater18 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater19 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater20 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater21 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater22 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater23 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater24 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater25 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater26 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater27 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater28 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater29 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater30 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater31 = LayoutInflater.from(FestivalPost.getAppInstance())
            val mInflater32 = LayoutInflater.from(FestivalPost.getAppInstance())
            ...
            try {
                ...
                params1.width = dpToPx(130, FestivalPost.getAppInstance())
                params3.width = dpToPx(130, FestivalPost.getAppInstance())
                params4.width = dpToPx(130, FestivalPost.getAppInstance())
                params5.width = dpToPx(130, FestivalPost.getAppInstance())
                params6.width = dpToPx(130, FestivalPost.getAppInstance())
                params7.width = dpToPx(130, FestivalPost.getAppInstance())
                params8.width = dpToPx(130, FestivalPost.getAppInstance())
                params9.width = dpToPx(130, FestivalPost.getAppInstance())
                params11.width = dpToPx(130, FestivalPost.getAppInstance())
                params12.width = dpToPx(130, FestivalPost.getAppInstance())
                params13.width = dpToPx(130, FestivalPost.getAppInstance())
                params14.width = dpToPx(130, FestivalPost.getAppInstance())
                params15.width = dpToPx(130, FestivalPost.getAppInstance())
                params16.width = dpToPx(130, FestivalPost.getAppInstance())
                params17.width = dpToPx(130, FestivalPost.getAppInstance())
                params18.width = dpToPx(130, FestivalPost.getAppInstance())
                params19.width = dpToPx(130, FestivalPost.getAppInstance())
                params20.width = dpToPx(130, FestivalPost.getAppInstance())
                params21.width = dpToPx(130, FestivalPost.getAppInstance())
                params22.width = dpToPx(130, FestivalPost.getAppInstance())
                params23.width = dpToPx(130, FestivalPost.getAppInstance())
                params24.width = dpToPx(130, FestivalPost.getAppInstance())
                params25.width = dpToPx(130, FestivalPost.getAppInstance())
                params26.width = dpToPx(130, FestivalPost.getAppInstance())
                params27.width = dpToPx(130, FestivalPost.getAppInstance())
                params28.width = dpToPx(130, FestivalPost.getAppInstance())
                params29.width = dpToPx(130, FestivalPost.getAppInstance())
                params30.width = dpToPx(130, FestivalPost.getAppInstance())
                params31.width = dpToPx(130, FestivalPost.getAppInstance())
                params32.width = dpToPx(130, FestivalPost.getAppInstance())
                params1.height = dpToPx(130, FestivalPost.getAppInstance())
                params3.height = dpToPx(130, FestivalPost.getAppInstance())
                params4.height = dpToPx(130, FestivalPost.getAppInstance())
                params5.height = dpToPx(130, FestivalPost.getAppInstance())
                params6.height = dpToPx(130, FestivalPost.getAppInstance())
                params7.height = dpToPx(130, FestivalPost.getAppInstance())
                params8.height = dpToPx(130, FestivalPost.getAppInstance())
                params9.height = dpToPx(130, FestivalPost.getAppInstance())
                params11.height = dpToPx(130, FestivalPost.getAppInstance())
                params12.height = dpToPx(130, FestivalPost.getAppInstance())
                params13.height = dpToPx(130, FestivalPost.getAppInstance())
                params14.height = dpToPx(130, FestivalPost.getAppInstance())
                params15.height = dpToPx(130, FestivalPost.getAppInstance())
                params16.height = dpToPx(130, FestivalPost.getAppInstance())
                params17.height = dpToPx(130, FestivalPost.getAppInstance())
                params18.height = dpToPx(130, FestivalPost.getAppInstance())
                params19.height = dpToPx(130, FestivalPost.getAppInstance())
                params20.height = dpToPx(130, FestivalPost.getAppInstance())
                params21.height = dpToPx(130, FestivalPost.getAppInstance())
                params22.height = dpToPx(130, FestivalPost.getAppInstance())
                params23.height = dpToPx(130, FestivalPost.getAppInstance())
                params24.height = dpToPx(130, FestivalPost.getAppInstance())
                params25.height = dpToPx(130, FestivalPost.getAppInstance())
                params26.height = dpToPx(130, FestivalPost.getAppInstance())
                params27.height = dpToPx(130, FestivalPost.getAppInstance())
                params28.height = dpToPx(130, FestivalPost.getAppInstance())
                params29.height = dpToPx(130, FestivalPost.getAppInstance())
                params30.height = dpToPx(130, FestivalPost.getAppInstance())
                params31.height = dpToPx(130, FestivalPost.getAppInstance())
                params32.height = dpToPx(130, FestivalPost.getAppInstance())
            ...
            val newLayout1 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout3 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout4 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout5 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout6 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout7 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout8 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout9 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout11 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout12 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout13 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout14 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout15 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout16 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout17 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout18 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout19 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout20 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout21 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout22 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout23 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout24 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout25 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout26 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout27 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout28 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout29 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout30 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout31 = LayoutInflater.from(FestivalPost.getAppInstance())
            val newLayout32 = LayoutInflater.from(FestivalPost.getAppInstance())
