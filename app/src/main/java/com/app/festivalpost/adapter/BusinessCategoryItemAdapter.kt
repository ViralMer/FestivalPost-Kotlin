...
class BusinessCategoryItemAdapter(var context: Context, var originaldata: ArrayList<BusinessCategory?>) :
    RecyclerView.Adapter<BusinessCategoryItemAdapter.ViewHolder>() {
    var searchCount = 0
