...
public interface    OnPhotoEditorListener {
     ...
     */
        void onEditTextChangeListener(View rootView, String text, int colorCode, int viewList);
     ...
     * @param viewType enum which define type of view is added
     */
    void onStartViewChangeListener(ViewType viewType, int numberOfAddedViews, View view);
     ...
     * @param viewType enum which define type of view is added
     */
    void onStopViewChangeListener(ViewType viewType, int numberOfAddedViews, View view);
